...
abstract class LightOpenIDProvider
{
        ...
        if (
            ...
            switch ($this->data['openid_mode']) {
                ...
                case 'checkid_setup':
                    ...
                    if (
                        ($identity = $this->checkid($this->data['openid_realm'], $attrValues))
    ...
    protected function ax()
    {
        ...
        foreach ($this->data as $name => $value) {
            if (
                strpos($name, 'openid_' . $alias . '_type') === false
    ...
    protected function sreg()
    {
        ...
        if (
            empty($this->data['openid_sreg_required'])
    ...
    protected function positiveResponse($identity, $attributes)
    {
        ...
        if (
            isset($this->data['openid_assoc_handle'])
